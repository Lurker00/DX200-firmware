...
### Android mode
* Added **Google Play Market**. It is not the latest version available, but it corresponds to the pre-installed Google Play Services. Can be disabled and enabled back via [***System settings***](https://github.com/Lurker00/DX200-USB-Audio-Release/blob/master/README.md#system-settings) of [USB Audio app](https://github.com/Lurker00/DX200-USB-Audio-Release/blob/master/README.md), along with Google Services.
...
* Embedded [**USB Audio application**](https://github.com/Lurker00/DX200-USB-Audio-Release/blob/master/README.md) with advanced features, possible only for a built-in app. In its [***System settings***](https://github.com/Lurker00/DX200-USB-Audio-Release/blob/master/README.md#system-settings) you can disable Google services and Media scanner, and turn Android's Battery saver permanently on, to reduce background activity almost to zero level.
* Embedded a special build of [**HibyMusic**](https://play.google.com/store/apps/details?id=com.hiby.music), compatible with [USB Audio app](https://github.com/Lurker00/DX200-USB-Audio-Release/blob/master/README.md). All the required changes made by me, with kind permission of [HiBy Music](http://www.hiby.cd/index_en.aspx). This build may co-exist with official releases installed from Google PlayMarket.
