...
On device boot, USB Audio produces a beep. This is a workaround of the related problem: if no sound was played after DX200 boot, its audio part never goes to sleep, draining the battery.
